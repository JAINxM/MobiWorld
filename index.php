...
<div class="flex overflow-x-auto pb-8 mb-10 gap-4 no-scrollbar">
    <?php
    $brands = ['All', 'Apple', 'Samsung', 'Google', 'OnePlus', 'Xiaomi', 'Sony', 'Asus'];
    foreach ($brands as $brand):
    ?>
        <button class="px-6 py-2 rounded-full whitespace-nowrap font-semibold border border-slate-200 bg-white text-slate-600 hover:border-primary hover:text-primary transition">
            <?php echo $brand; ?>
        </button>
    <?php endforeach; ?>
</div>
